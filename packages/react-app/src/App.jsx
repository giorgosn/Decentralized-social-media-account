...
import { Home, ExampleUI, Hints, Subgraph, Snapshot } from "./views";
    ...
    <div className="App">
      ...
      <Menu style={{ textAlign: "center" }} selectedKeys={[location.pathname]} mode="horizontal">
        ...
        <Menu.Item key="/snapshot">
          <Link to="/snapshot">Snapshot app</Link>
        </Menu.Item>
        <Menu.Item key="/debug">
      ...
      <Switch>
        ...
        <Route exact path="/snapshot">
          {/* pass in any web3 props to this Home component. For example, yourLocalBalance */}
          <Snapshot yourLocalBalance={yourLocalBalance} readContracts={readContracts} />
        </Route>
